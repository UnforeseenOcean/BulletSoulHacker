...
public class SoundGroupVariation : MonoBehaviour
{
    ...
    private bool sourceIsListener = false;
    ...
    public void Play(float? pitch, float maxVolume, PlaySoundParams playParams = null)
    {
        ...
        if (playParams.attachToSource || useClipAgePriority)
        {
	        ...
	        sourceIsListener = ObjectToFollow != null && ObjectToFollow.GetComponentInChildren<AudioListener>() != null;
    ...
    private IEnumerator FollowSoundMaker()
    {
        ...
        {
			var timeToWait = sourceIsListener ? Time.deltaTime : MasterAudio.INNER_LOOP_CHECK_INTERVAL;
