			...
			for (var i = 0; i < _group.groupVariations.Count; i++) {
				...
				case MasterAudio.AudioLocation.Clip:
					...
					if (newClip != variation.GetComponent<AudioSource>().clip) {
						UndoHelper.RecordObjectPropertyForUndo(variation.GetComponent<AudioSource>(), "change Audio Clip");
				...
				if (newVolume != variation.GetComponent<AudioSource>().volume) {
					UndoHelper.RecordObjectPropertyForUndo(variation.GetComponent<AudioSource>(), "change Volume");
				...
				if (newPitch != variation.GetComponent<AudioSource>().pitch) {
					UndoHelper.RecordObjectPropertyForUndo(variation.GetComponent<AudioSource>(), "change Pitch");
				...
				if (newLoop != variation.GetComponent<AudioSource>().loop) {
					UndoHelper.RecordObjectPropertyForUndo(variation.GetComponent<AudioSource>(), "toggle Loop Clip");
