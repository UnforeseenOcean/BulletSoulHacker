	...
	private void UpgradeData() {
		...
		for (var g = 0; g < _creator.soundGroupsToCreate.Count; g++) {		
			...
			for (var v = 0; v < grp.variations.Count; v++) {
				...
				switch (aVar.audLocation) {
					case MasterAudio.AudioLocation.Clip:
						varScript.GetComponent<AudioSource>().clip = aVar.clip;
						break;
					case MasterAudio.AudioLocation.ResourceFile:
				...
				varScript.GetComponent<AudioSource>().volume = aVar.volume;
				varScript.GetComponent<AudioSource>().pitch = aVar.pitch;
				varScript.GetComponent<AudioSource>().loop = aVar.loopClip;
				...
				varScript.GetComponent<AudioSource>().rolloffMode = aVar.audRollOffMode;
				varScript.GetComponent<AudioSource>().minDistance = aVar.audMinDistance;
				varScript.GetComponent<AudioSource>().maxDistance = aVar.audMaxDistance;
				varScript.GetComponent<AudioSource>().dopplerLevel = aVar.audDopplerLevel;
				varScript.GetComponent<AudioSource>().spread = aVar.audSpread;
				varScript.GetComponent<AudioSource>().spatialBlend = aVar.audPanLevel;
			}
		}
